<template>
  <div>
    ...
    <a-spin :spinning="spinning">
      <apexchart type="area" height="350" :options="chartOptions" :series="series" loading></apexchart>
    </a-spin>
  </div>
</template>
  ...
  watch: {
    'data': {
      ...
      handler: function (newV) {
        console.log('renwu4 data', newV, this.form.date)
        this.HandleChange()
      }
    },
  },
